...
{
    public static class WeChat_PuertsBeefBallBehaviour_Wrap
    {
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = new WeChat.PuertsBeefBallBehaviour();
                        
                        
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(WeChat.PuertsBeefBallBehaviour), result);
                    }
                }
        ...
        private static void G_JSClassName(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as WeChat.PuertsBeefBallBehaviour;
                var result = obj.JSClassName;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_JsOnEnable(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as WeChat.PuertsBeefBallBehaviour;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_JsOnEnable(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as WeChat.PuertsBeefBallBehaviour;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.JsOnEnable = argHelper.Get<System.Action>(false);
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_JsOnDisable(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as WeChat.PuertsBeefBallBehaviour;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_JsOnDisable(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as WeChat.PuertsBeefBallBehaviour;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.JsOnDisable = argHelper.Get<System.Action>(false);
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Properties = new System.Collections.Generic.Dictionary<string, Puerts.PropertyRegisterInfo>()
                {
                    ...
                    {"JsOnEnable", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_JsOnEnable, Setter = S_JsOnEnable} },
                    {"JsOnDisable", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_JsOnDisable, Setter = S_JsOnDisable} },
